...
public class calculator extends javax.swing.JFrame {
    ...
    public void arithmetic()
    {
        switch(calculation)
        {
            case 1:ans=num+Double.parseDouble(jTextField2.getText());
                   jTextField2.setText(Double.toString(ans));
                   break;
            case 2:ans=num-Double.parseDouble(jTextField2.getText());
                   jTextField2.setText(Double.toString(ans));
                   break;
            case 3:ans=num*Double.parseDouble(jTextField2.getText());
                   jTextField2.setText(Double.toString(ans));
                   break;       
             case 4:ans=num/Double.parseDouble(jTextField2.getText());
                   jTextField2.setText(Double.toString(ans));
                   break;       
        }
    }
